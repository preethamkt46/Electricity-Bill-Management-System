...
<body>
    ...
    <div class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <img src="assets\img\thunderlogo.png" alt="Thunder Logo" class="navbar-logo">
            <a class="navbar-brand" href="index.php"><b>VIDYUT</b></a>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 signup">
                        ...
                        <p>Experience hassle-free electricity billing. No queues, just seamless transactions. Trust our reliability and accuracy for peace of mind. Manage your expenses effortlessly with our dedicated team at your service. We understand the importance of convenience and efficiency in your busy life, which is why we offer tailored payment methods to suit your needs. Join us and simplify your electricity bill payments today!</p>
...
<footer class="footer">
    <div class="footer-container">
        ...
        <div class="footer-contact">
            <h2>Contact Us</h2>
            <ul>
                <li>📍 Building 46 Canvas street, Pin-512345, India</li>
                <li>✉️ vidyutsupport@gmail.com</li>
                <li>📞 +91 xxxxx 60908</li>
                <li>📞 +91 xxxxx 93306</li>
            </ul>
        </div>
    ...
    <div class="footer-company-logo">
        <img src="assets/img/thunderlogo.png" alt="Thunder Logo" class="company-logo">
        <h2 class="company-name">VIDYUT</h2>
    </div>
    <p class="company-moto">Efficiency at Every Step – Fast, Reliable, and Hassle-Free Billing Solutions!</p>
</div>
    </div>

    <!-- Footer Bottom -->
    <div class="footer-bottom">
        <p>Copyright © 2023 Preetham K T. All rights reserved.</p>
    </div>
</footer>
