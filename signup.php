...
<center>
    ...
    <div class="form-group">
        <div class="col-md-12">
            <input type="password" class="form-control" name="inputPassword" id="inputPassword" title="Please enter a 10-digit number" placeholder="Password" required>
    ...
    <div class="form-group">
    <div class="col-md-12">
        <input type="tel" class="form-control" name="contactNo" pattern="[0-9]{10}" title="Please enter a 10-digit number" placeholder="Contact No." required>
